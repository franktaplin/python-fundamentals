...
# a multi-line string uses three single or double quotes and allows
# a string to be creatd on multiple lines.
multi = '''This string can be
seen on multiple lines so you could do
...
# This technique is the ability to compare a set of characterw with a string
...
# basic string format method is using only a curly brace
age = 4
...
# String methods are built in to Python
